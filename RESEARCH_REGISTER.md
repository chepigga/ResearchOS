...
|---|---|---|---|---|---|---|---|---|
| FXArena | Entry Lab market/limit/hybrid tournament | v001 | 2026-07-24 | COMPLETED / CLOSED | E0 +2256.51R, gross DD 12.436807R; best candidate E3 +1847.72R; all candidate bootstrap total probabilities 0% | F10 — market@D3+60 optimal; Entry layer closed | Do not reopen timing grids without new causal information; continue exact execution/deploy closure | [Report](Projects/FXArena/Releases/v1.2/EntryLab_v001/FXArena_EntryLab_v001_Report.md) |
| FXArena | Pure limit entries | v001 E1/E2 | 2026-07-24 | FALSIFIED | Fill 34.23%/31.63%; missed TB 64.05%/66.95%; DD 20.584R/20.991R | FAIL EL1, EL2, EL4, EL5 | Keep closed; limit starvation removes the TB profit engine | [Summary](Projects/FXArena/Releases/v1.2/EntryLab_v001/EntryLab_v001_arm_summary.csv) |
| FXArena | Confirmation and hybrid entries | v001 E3–E6 | 2026-07-24 | FALSIFIED | Totals +1847.72R to +1648.59R versus E0 +2256.51R; all DD above 15.94R | FAIL EL1, EL2 and EL4 | No promotion or tick-validation candidate | [Gates](Projects/FXArena/Releases/v1.2/EntryLab_v001/EntryLab_v001_gates.csv) |
...
Entry Lab v001 found no market/limit/confirmation alternative that preserved the frozen P4b economics. Pure limits starved the TB branch, while confirmation and hybrid arms paid more through delayed/adversely selected entries. `market @ D3+60s` is retained and the Entry layer is closed as F10.
