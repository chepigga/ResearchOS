...
| Grok XAU | FT core deep oracle | FT_DEEP_001 | INCONCLUSIVE / PARTIAL REGIME SIGNAL / FULL DATA REQUIRED | AK47_FT_EA_156 NYBUY + LONBUY defaults; source SHA256 `838b3e...8311b65` | determine persistent edge versus regime concentration over 2023-01..2026-07 | uploaded file truncated to 100,000 rows; warmup-safe suffix N=27 EV_net=+2.160244R; top-3 months 93.31%; Step0 count PASS but time-overlap blocked; no tuning and no formal REGIME claim | [Spec](Projects/Grok_XAU/Specs/TZ-FT-DEEP-001.md) · [Partial report](Projects/Grok_XAU/Reports/FT_DEEP_001_PartialRun_2026-07-25.md) |
...
For Grok XAU, `Projects/Grok_XAU/STATUS.md` is the operational source of truth. BH OOS PASS permits `InpBH_Enable=true` only on demo at the frozen 0.30% risk. FT_DEEP remains INCONCLUSIVE until Step 0 time parity passes and full same-feed M5 history with 200-D1 warmup is available. The partial 93.31% top-three-month concentration is evidence of regime dependence, not a deployment decision.
