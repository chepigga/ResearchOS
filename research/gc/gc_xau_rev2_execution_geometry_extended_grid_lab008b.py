...
OUT_JSON=ROOT/'GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B.json'
OUT_MD=ROOT/'GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B.md'
OUT_CSV=ROOT/'GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B_GRID.csv'
OUT_LEDGER=ROOT/'GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B_LEDGER.csv'

CLOCK_OFFSET_MIN=180
STALE_MS=2000
HORIZON_MS=300000
SLS=[round(x,2) for x in np.arange(0.25,4.0001,0.25)]
TPS=[round(x,2) for x in np.arange(0.50,8.0001,0.25)]
...
def main():
    ...
    out={
      'lab':'GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B',
    ...
    def f(v,d=3):
        ...
        return f'{v:.{d}f}'
    lines=['# GC_XAU_REV2_EXECUTION_GEOMETRY_EXTENDED_GRID_LAB008B','',
           'Status: WIDE_GEOMETRY_SURFACE_NOT_PRODUCTION_OPTIMIZATION','',
