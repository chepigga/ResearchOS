"""
XAU_POOL_SELECTION_LAB_001 | КРОК 7 — OOS-1
...
OOS1=[m for m in sorted(P.ym.unique()) if '2024-04'<=m<='2025-01']
print("="*74); print("КРОК 7 — OOS-1"); print("="*74)
...
W.to_parquet('/home/claude/oos1_scored.parquet',index=False)
