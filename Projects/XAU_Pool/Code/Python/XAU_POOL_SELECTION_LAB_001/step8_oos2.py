"""
XAU_POOL_SELECTION_LAB_001 | КРОК 8 — OOS-2
...
OOS1=[m for m in sorted(P.ym.unique()) if '2025-02'<=m<='2025-12']
print("="*74); print("КРОК 8 — OOS-2"); print("="*74)
...
W.to_parquet('/home/claude/oos2_scored.parquet',index=False)
