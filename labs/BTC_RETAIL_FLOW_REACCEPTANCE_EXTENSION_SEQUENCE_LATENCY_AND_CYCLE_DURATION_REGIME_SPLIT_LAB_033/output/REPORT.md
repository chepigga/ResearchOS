...
**Verdict: FAIL_NO_CAUSAL_SEQUENCE_REGIME_SPLIT — 7/12**

## Lineage / parity
- EXTENSION050 pre-Aug: **600**; 2025H2 **56**, 2026 Jan-Jul **56**
- Clock ordering: **100.000%**
- First failure timestamp parity: **100.000%**
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| signal_to_accept_h | 0.250 | 0.250 | -0.067 | 0.433 | 0.872 | -0.045 | 0.268 | no |
| accept_to_failure_h | 1.250 | 1.000 | -0.073 | 0.507 | 0.872 | -0.012 | 0.762 | no |
| failure_to_origin_reclaim_h | 0.750 | 0.750 | 0.005 | 0.962 | 1.000 | -0.001 | 0.983 | no |
| failure_to_full_reaccept_h | 1.500 | 1.250 | -0.051 | 0.640 | 0.872 | -0.005 | 0.897 | no |
| reaccept_to_extension_h | 0.250 | 0.250 | 0.040 | 0.609 | 0.872 | -0.018 | 0.658 | no |
| signal_to_extension_h | 4.875 | 3.500 | -0.124 | 0.257 | 0.872 | 0.007 | 0.858 | no |
| accept_to_extension_h | 4.500 | 3.250 | -0.115 | 0.293 | 0.872 | 0.010 | 0.802 | no |
| extra_bad_closes_before_reaccept | 2.000 | 3.000 | -0.070 | 0.525 | 0.872 | -0.020 | 0.631 | no |
| cycle_count_accept_to_extension | 1.000 | 1.000 | 0.000 | 1.000 | 1.000 | — | — | no |
| origin_bad_close_count_accept_to_extension | 6.000 | 5.000 | -0.043 | 0.697 | 0.872 | -0.027 | 0.511 | no |
...
- PASS — `reconstructed_failure_parity_ge_99pct`
