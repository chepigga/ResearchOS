...
def remove_canonical_overlap_fixed(sel,canon):
    """Execution-only lineage parity fix.
    Reproduces LAB016 v2 by converting both event-time vectors to integer nanoseconds.
    No parent, router, child, execution, maturity, cost, gate, or threshold change.
    """
...
L17.L16.remove_canonical_overlap=remove_canonical_overlap_fixed
