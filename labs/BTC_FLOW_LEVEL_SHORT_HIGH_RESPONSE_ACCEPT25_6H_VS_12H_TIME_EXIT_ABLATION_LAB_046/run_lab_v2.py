...
def _fixed_simulate(r,fut,policy):
    # Computational-only parity fix: preserve LAB044 eligibility universe.
    # Any ACCEPT known at/after original signal+12h was a no-trade in LAB044
    # and remains a no-trade for ENTRY_PLUS_6H. Only the exit horizon changes.
